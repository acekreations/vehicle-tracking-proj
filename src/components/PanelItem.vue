<template>
	<div class="item">
		<div class="left-col">
			<h4>Vehicle Name</h4>
			<p class="text-medium-gray">Driver Name</p>
			<p class="small text-medium-gray">Near: 1234 Main St., San Fernando, CA</p>
		</div>
		<div class="right-col">
			...
			<div class="speed bg-green">
				<p>63</p>
				<p class="mph">mph</p>
			</div>
			<img class="signal" src="./icons/signal-4.svg" />
		</div>
	</div>
</template>
